<x-layout title="SeriesHub - Cadastrar série">
    ...
    <form class="form-cadastro" action="{{ route('series.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <h1 class="titulo-cadastro" class="text-center mt-4" style="color: pink; margin-right: 100px; font-weight: bold">Adicione sua Série</h1>
